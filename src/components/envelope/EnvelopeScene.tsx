...
export function EnvelopeScene({ atmosphereRef, siteRef, onCardVisible, onComplete }: Props) {
  ...
  const collect = useCallback((): EnvelopeElements | null => {
    const els = {
      ...
      card: card.current,
      cardFace: cardFace.current,
      cardShadow: cardShadow.current,
  ...
  return (
    <div className="stage" ref={stage}>
      ...
      <div className="stage__inner" ref={stageInner}>
        ...
        <InvitationCard cardRef={card} faceRef={cardFace} shadowRef={cardShadow} />
