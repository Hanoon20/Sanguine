...
/**
 * One flap: an outer burgundy face and an inner printed face, held apart in
 * depth so the paper has thickness, with two shading layers the timeline
 * drives as the fold turns.
 */
